	...
	export default {
		...
		watch: {
			apiKey: function (value) {
				this.$cookies.set('apiKey', value, '1y', null, null, process.env.NODE_ENV === 'production')
			},
			secretKey: function (value) {
				this.$cookies.set('secretKey', value, '1y', null, null, process.env.NODE_ENV === 'production')
			},
